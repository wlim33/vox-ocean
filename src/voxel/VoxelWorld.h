...
enum class VoxMat : uint8_t { Air = 0, Water = 1, Sand = 2, Rock = 3, Boat = 4, Kelp = 5, Fish = 6, SandGrain = 7 };
inline constexpr int kNumMaterials = 8;  // == NUM_MATERIALS in shaders/shader_types.h

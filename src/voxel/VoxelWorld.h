...
enum class VoxMat : uint8_t { Air = 0, Water = 1, Sand = 2, Rock = 3, Boat = 4, Kelp = 5, Fish = 6, SandGrain = 7, Bubble = 8, Fire = 9, Smoke = 10, Ash = 11, Steam = 12 };
inline constexpr int kNumMaterials = 13;  // == NUM_MATERIALS in shaders/shader_types.h

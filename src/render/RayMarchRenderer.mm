...
void RayMarchRenderer::init(const MetalContext& ctx, PipelineCache& cache) {
...
void RayMarchRenderer::resize(const MetalContext& ctx, int drawable_w, int drawable_h,
                              const Config& cfg) {
...
void RayMarchRenderer::draw_into_drawable(void* render_encoder) {

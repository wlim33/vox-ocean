...
// Writes `material` into a CPU-supplied list of packed cell indices, after
// world_fill so entities overwrite water. Index decode is the lockstep
    ...
    uint gid [[thread_position_in_grid]])
{
    ...
    world.write(uint4((uint)U.material, 0, 0, 0), uint3(ix, iy, iz));
}
